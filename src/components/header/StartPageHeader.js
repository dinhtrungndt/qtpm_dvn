        ...
        <div className="hidden md:flex items-center justify-center border border-gray-300 rounded-full px-4 py-2 gap-2 relative hover:border-gray-400 transition-colors">
          ...
          <div className="relative" ref={categoryRef}>
            ...
            >
              {categorySearch}
              <ChevronDown
                className={`w-4 h-4 transition-transform duration-200 ${isOpenCategoryDropdown ? 'rotate-180' : ''}`}
              />
            </button>
          ...
          {isAuthenticated && (
            <div className="relative" ref={favoritesRef}>
              ...
              <button
                ...
                className="p-2 bg-red-500 rounded-full text-white hover:bg-red-600 transition-colors shadow-sm hover:shadow-md"
              >
