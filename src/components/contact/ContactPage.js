      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="animate-fade-in" style={{ animationDelay: '250ms' }}>
            <div className="bg-slate-700 rounded-xl border border-slate-600 p-8 shadow-xl">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-lg bg-slate-600 border border-slate-500 text-white placeholder-slate-400 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows="5"
                    className="w-full px-4 py-3 rounded-lg bg-slate-600 border border-slate-500 text-white placeholder-slate-400 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all resize-none"
                  />
                </div>
          ...
          <div className="space-y-8 animate-fade-in" style={{ animationDelay: '300ms' }}>
            {/* Business Hours */}
            <div className="bg-slate-700 rounded-xl border border-slate-600 p-8 shadow-xl">
              <h3 className="text-2xl font-bold text-white mb-6">Giờ Làm Việc</h3>
              <div className="space-y-3">
                <div className="flex justify-between items-center pb-3 border-b border-slate-600">
                  <span className="text-slate-300 font-medium">Thứ Hai - Thứ Sáu</span>
                  <span className="text-white font-bold">8:00 - 18:00</span>
                </div>
                <div className="flex justify-between items-center pb-3 border-b border-slate-600">
                  <span className="text-slate-300 font-medium">Thứ Bảy</span>
                  <span className="text-white font-bold">9:00 - 17:00</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-slate-300 font-medium">Chủ Nhật</span>
            ...
            {/* Map Embed */}
            <div className="bg-slate-700 rounded-xl border border-slate-600 overflow-hidden shadow-xl h-64 md:h-80">
              <iframe
