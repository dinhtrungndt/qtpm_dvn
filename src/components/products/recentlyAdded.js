        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-xs font-medium transition-colors ${!selectedFramework
            ...
            {frameworks.map(framework => (
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-xs font-medium transition-colors ${selectedFramework === framework
                  ? 'bg-blue-500 text-white'
                  : 'bg-white text-blue-500 border border-blue-500 hover:bg-blue-100'
                  }`}
              >
