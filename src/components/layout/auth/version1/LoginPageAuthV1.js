      ...
      <div className="w-full max-w-md animate-fadeIn">
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-2xl p-8 animate-slideUp border border-white/20">
          ...
          <div className="text-center mb-6">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full mb-3 animate-bounce-slow shadow-lg">
          ...
          <div className="mt-6 space-y-2 text-center">
            <Link to="/forgot-password" className="block text-blue-600 hover:text-blue-800 hover:underline transition-colors text-sm font-medium group">
            ...
            <Link to="/register" className="block text-blue-600 hover:text-blue-800 hover:underline transition-colors text-sm font-medium group">
              <span className="inline-flex items-center gap-1">
